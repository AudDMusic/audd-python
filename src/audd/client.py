...
def _format_return(return_: str | Iterable[str] | None) -> str | None:
    if return_ is None:
        return None
...
class AudD(_BaseClient):
    ...
    def custom_catalog(self) -> Any:
        if self._custom_catalog is None:
            ...
            self._custom_catalog = CustomCatalog(self._http, self._mutating_policy())
    ...
    def recognize(
        ...
        source: Source,
        *,
        return_: str | Iterable[str] | None = None,
    ...
    **Server-side metering still consumes credit even if the local call is
    ...
    def custom_catalog(self) -> Any:
        if self._custom_catalog is None:
            ...
            self._custom_catalog = AsyncCustomCatalog(self._http, self._mutating_policy())
        return self._custom_catalog
